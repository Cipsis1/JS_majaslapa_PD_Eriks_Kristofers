...
function resetCardGame() {
    ...
    resultHTML.innerText = "Tu atbildēji: ";
    scoreHTML.innerText = "Tu atbildēji  " + numCorrect + "/" + numQuestionsAsked + " pareizi";
}
...
function updateDisplay(correctGuess) {
    let result = correctGuess ? "Pareizi" : "Nepareizi";
    resultHTML.innerText = "Tu atbildēji: " + result;
    scoreHTML.innerText = "Tu atbildēji  " + numCorrect + "/" + numQuestionsAsked + " pareizi";
}
